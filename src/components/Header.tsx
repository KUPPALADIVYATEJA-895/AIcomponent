        ...
        <div className="flex items-center gap-2">
          {onOpenRbacModal && (
            <button
              ...
              className="px-2 py-0.5 rounded bg-[#141d2b] hover:bg-[#1d293d] border border-[#232f42] text-slate-300 hover:text-white flex items-center gap-1 cursor-pointer transition-colors"
              title="Access Control & Security Audit Logs"
            >
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base sm:text-lg font-extrabold text-white tracking-tight font-['Chakra_Petch',sans-serif]">
                AURA (Autonomous Unified Reliability & Anomaly Intelligence)
              </h1>
            </div>
          </div>
        </div>
